...
if __name__ == "__main__":
    base = os.path.expanduser("~/GIT/social_sampling_in_epidemics/simulations/study_params_20220822/")
    networks_folder = os.path.join(base,"results_trimmed/JOB643520")
    rds_config = os.path.join(base,"rds_config.json")
    results = run_each(rds_config,networks_folder)
    results.to_csv("all_summaries_hiv_pos_20220831.csv",index=False)
