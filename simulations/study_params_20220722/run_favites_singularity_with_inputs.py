...
COMMAND += ['-B','/home/b37v456/GIT/social_sampling_in_epidemics/simulations/study_params_20220722/contact_config.json:/FAVITES_MOUNT/contact_config.json']
COMMAND += ['-B','initial_contact_graph.csv:/FAVITES_MOUNT/initial_contact_graph.csv']
###################
