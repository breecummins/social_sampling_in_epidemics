...
COMMAND += ['-v','/Users/b37v456/GIT/social_sampling_in_epidemics/tests/single_run_test/contact_config.json:/FAVITES_MOUNT/contact_config.json']
COMMAND += ['-v','/Users/b37v456/GIT/social_sampling_in_epidemics/tests/single_run_test/initial_contact_graph.csv:/FAVITES_MOUNT/initial_contact_graph.csv']
###################
