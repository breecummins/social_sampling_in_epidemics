...
COMMAND += ['-v','/home/bree/GIT/social_sampling_in_epidemics/simulations/check_incidence/contact_config.json:/FAVITES_MOUNT/contact_config.json']
COMMAND += ['-v','/home/bree/GIT/social_sampling_in_epidemics/simulations/check_incidence/initial_contact_graph.csv:/FAVITES_MOUNT/initial_contact_graph.csv']
###################
